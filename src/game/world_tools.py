...
def new_world(console_width: int, console_height: int) -> Registry:
    ...
    # draw player
    Player.draw_player(world, console_width, console_height)
    ...
    # draw rooms // TODO: make a dungeon generator, implement here
    ...
    Enemy.draw_enemy(world, rng, console_width, console_height)
    #draw enemies
